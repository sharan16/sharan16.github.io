importScripts('./media.js?v=tree4');
const CACHE='body-shell-v4';
const IMAGES=[...new Set(Object.values(BODY_MEDIA.assets).flatMap(a=>a.frames.map(f=>f.src)))];
const ASSETS=['./','./index.html','./style.css?v=tree4','./app.js?v=tree4','./data.js?v=tree4','./media.js?v=tree4','./store.js?v=tree4','./config.js','./icon.svg','./manifest.json',...IMAGES];
